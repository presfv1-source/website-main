...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center py-16 md:py-24 overflow-hidden bg-[#0A0F1E]">
      <div className="relative w-full">
        <div className={cn(CONTAINER_WIDE, PAGE_PADDING)}>
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-[#94A3B8] max-w-2xl mt-4 leading-relaxed">
            ...
            <p className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 text-xs text-[#94A3B8] border border-white/10 mt-6">
              Built for Texas brokerages · Beta · Limited spots · Setup in minutes
            </p>
            <div className="w-full max-w-3xl mx-auto mt-16 rounded-2xl overflow-hidden ring-1 ring-white/10 shadow-[0_0_60px_rgba(37,99,235,0.12)]">
              <DashboardMockup />
            </div>
          </div>
        </div>
